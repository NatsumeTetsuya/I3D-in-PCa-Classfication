...
model = dict(
    ...
    backbone=dict(  # Backbone 字典设置
        ...
        pretrained="/home/chenpeizhe/.cache/torch/hub/checkpoints/resnet50-0676ba61.pth",  # 预训练模型的 url 或文件位置
        ...
        train_cfg= dict(blending=dict(type='MixupBlending', num_classes=2, alpha=.2)),
...
log_level = 'INFO'  # 日志等级
work_dir = './work_dirs/tsn/'  # 记录当前实验日志和模型权重文件的文件夹
load_from = None#"/home/chenpeizhe/project/guokeda/dongyang/classfication/MMaction/pretrain/vmz_ircsn_ig65m_pretrained_r152_32x2x1_58e_kinetics400_rgb_20210617-e63ee1bd.pth"# 从给定路径加载模型作为预训练模型. 这个选项不会用于断点恢复训练
